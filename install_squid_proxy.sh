...
>>>>>>> 0017f34beaf1f66d698213f1b6300401642b7124
    else
...
${http_port_config}
<<<<<<< HEAD
# Prevent redirects - use IP from connection
visible_hostname $(hostname -f 2>/dev/null || echo "squid-proxy")
=======
visible_hostname squid-proxy
>>>>>>> 0017f34beaf1f66d698213f1b6300401642b7124
dns_v4_first on
# Disable redirects to ensure each IP works independently
...
# Security Settings - Prevent redirects and IP leaks
forwarded_for delete
via off
request_header_access Via deny all
request_header_access X-Forwarded-For deny all
request_header_access Forwarded-For deny all
# Ensure connections use the IP they connected to (no redirects)
# Each http_port binding above ensures independent IP handling
